    ...
    return (
      <div>
        ...
        <div class="info-container">
          ...
          <p>May 9, 2024</p>
          <p>Hello, this is a Com S 319 project that focuses on using a react native app in the front end and uses mongodb backend database access. The goal of this project is to refine and streamline the deck-building experience for Magic the Gathering players, providing a simpler alternative to Archidekt.com. By focusing on essential functionalities like card searching, filtering by attributes, and intuitive deck management, we aim to offer a more user-friendly platform for assembling and modifying decks.</p>
        </div>
      </div>
    );
  }
